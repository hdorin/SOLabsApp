<?php
//Chapter Commands
class Chapter_11_View_Question extends Controller
{
    const CHAPTER_ID=11;
    ...
    private $question_text="",$question_code="",$question_input="";
    ...
    {   
        ...
        $this->view('home/chapter_' . (string)self::CHAPTER_ID . '_view_question',['chapter_id' => (string)self::CHAPTER_ID,'chapter_name'=>$chapter_name,'question_id'=>$question_id, 'can_delete' =>$can_delete,'answers_left'=>$this->answers_left,
                                                                                  ...
                                                                                  'question_input' => $this->question_input,'date_submitted'=>$this->date_submitted,
