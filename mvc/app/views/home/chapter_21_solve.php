...
<body>
    ...
    <div class="questionBox">
        ...
        <div class="textareaKeybd">
            <h3>Input <br> keyboard:</h3>
        ...
        <div class="textareaCode">
            <textarea id="codeField" class="codeField" name="code_field" rows="10" cols="50" required maxlength="<?php echo (string)$data['code_field_max_len']; ?>"><?php echo $data['code_field']; ?></textarea>
        </div>
