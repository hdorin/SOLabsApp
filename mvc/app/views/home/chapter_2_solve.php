...
<head>
    ...
    <link rel="stylesheet" href="resources/stylesheets/chapter_2_solve.css" type="text/css" />
</head>
<body>
    <?php
        include "header.php"
    ...
    <div class="questionBox">
        ...
        <div class="textarea">
            <textarea class="codeField" name="code_field" rows="15" cols="50" required maxlength="1500"><?php echo $data['code_field']; ?></textarea>
        </div>
